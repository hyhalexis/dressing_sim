...
def evaluate(agent, video_dir, traj_dir, step, args):
    all_ep_rewards = []
    imsize = 720
    ...
    def run_eval_loop():
        ...
        for garment_id in garment_ids:
            ...
            for motion_id in motion_ids:
                ...
                # traj_obses = []
                obs = env.reset(motion_id=motion_id, garment_id=garment_id)
...
def main(args):
    ...
    all_whole_arm_ratios, all_upper_arm_ratios = evaluate(agent, video_dir, traj_dir, 0, args)
